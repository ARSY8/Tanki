...
class AStar:
    ...
    # def bfs(self, tank, enemy_tank):
    #     for ans in ["up", "down", "left", "right"]:
    #         timed_tank = EnemyTank(*enemy_tank.rect.center)
    #         count_ = 0
    #         while not timed_tank.check_collision(self.obstacles):
    #             count_ += 1
    #             if count_ > 1000:
    #                 break
    #             timed_tank.move(lambda : ans)
    #             tank_timed_copy = copy.copy(timed_tank)
    #             for i in ["up", "down", "left", "right"]:
    #                 tank_timed_copy.move(lambda : i)
    #                 if tank_timed_copy.check_kill(tank, []):
    #                     return ans
